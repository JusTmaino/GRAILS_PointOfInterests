            ...
            <div class="panel-body">
                <ol class="property-list image">
                    ...
                    <div class="form-group">
                        <img src="${grailsApplication.config.server.pathServer}/${this.image.filename}" class="img-circle" width = "100" height = "100" alt="Image"/>
                    </div>
                    ...
                    <div style="padding-left: 120px ">
                        ...
                        <div class="form-group">
                            <label>Date Created : </label> <span>${this.image.dateCreated}</span>
                        </div>
                    </div>
