                    ...
                    <form action="/image/save" method="post" enctype="multipart/form-data" >
                        <fieldset class="form">
                            ...
                            <div class='form-group'>
                                ...
                                <input type="text" class="form-control" name="filename" value="" required="" id="filename" />
                            </div>

                            <div class='form-group'>
                                <label for='date_created'>Date Created *</label>
                                <input type="hidden" id="date_created" name="date_created" value="date.struct" />
                        ...
                        <div id="dragandrophandler"> <input type="button" value="Click to select file" draggable="true" id="fakeBrowse" onclick="HandleBrowseClick();"/> drag & drop files here</div>
                        <br><br>
                        <div id="status1"></div>
